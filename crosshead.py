...
#Version 1.0
#Last Modified 20180401 @alvarodh5
...
def ascii():
	...
	print bcolors.LOGO + "       \/                  \/     \/       \/       \/     \/      \/ "+ bcolors.ENDC + bcolors.BLUE + "1.0" + bcolors.ENDC
...
if (len(sys.argv) == 1):
	...
	try:
		...
		analyze(cabecera)
    		...
    		print bcolors.RED+"[!] "+bcolors.ENDC+"Connection refused, check your proxy or internet connection."
    	except NameError:
    		print bcolors.RED+"[!] "+bcolors.ENDC+"Connection Aborted. Check your options."
